    ...
    def play(self):
        ...
        while is_running  and not starship_collided:
            ...
            if self._check_for_collision():
                if chances == 0:
                    self._display_message("You have two more chances.Pres any the spacebarto contiue:")
                    
                    self._pause
                elif chances == 1:
                    self._display_message("You have one more chance to continue:")
                    
                    self._pause

                elif chances == 2:
                    self._display_message("Game over.Thank you for playing")
                    time.sleep(0.4)
                    self._display_message(str(self.score))
                    time.sleep(0.4)
                    is_running = False
