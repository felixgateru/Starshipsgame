...
class Menu():
    def __init__(self,game):
        self.game = game
        self.mid_w, self.mid_h = self.game.frame_width/2, self.game.frame_height/2
    ...
    def blit_screen(self):
        self.game.display_surface.blit(self.game.game_surface,(0,0))
...
class MainMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text("Main Menu", 20, self.game.frame_width/2,self.game.frame_height/2 -20)
...
class OptionsMenu(Menu):
    ...
    def display_menu(self):
        ...
        self.game.draw_text("Options",20,self.game.frame_width/2,self.game.frame_height/2 -30)
