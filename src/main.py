...
class Game:
    def __init__(self):
        ...
        pygame.init()
        self.background_Object = ScrollingBackGround(FRAME_HEIGHT+60)
        self.background_time = pygame.time.Clock().tick(REFRESH_RATE)/2500.0
        ...
        self.meteors = [Meteor(self)
                        for _ in range(0, INITIAL_NUMBER_OF_METEORS)]
    ...
    def _display_message(self, message):
        ...
        text_surface = text_font.render(
            message, True, (0, 0, 255), (255, 255, 255))
    ...
    def _display_score(self, score):
        ...
        text_rectangle.center = (
            FRAME_WIDTH-text_rectangle.width/2, text_rectangle.height/2 + 5)
    ...
    def play(self):
        ...
        while is_running and not starship_collided:
            count += 1
            self.background_Object.updateCoords(BACKGROUND_SPEED, self.background_time)
            for event in pygame.event.get():
